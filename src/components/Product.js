...
const Product = ({ data }) => {
  ...
  return (
    <div className='col-4 mt-3'>
      <div className='card'>
        <img width="100px" height="200px" src={data.url} className="card-img-top" alt="..." />
        ...
        <div className="card-body">
          ...
          <div className="input-group my-3">
            <span className="input-group-btn">
              <button type="button" className="quantity-left-minus btn btn-primary btn-number "
                onClick={decrement} >
            ...
            <span className="input-group-btn">
              <button type="button" className="quantity-right-plus btn btn-primary btn-number"
                onClick={increment}>
